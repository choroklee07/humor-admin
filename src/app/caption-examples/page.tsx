    ...
    <AdminShell user={{ email: currentUser?.email }}>
      <div className="p-8 space-y-6">
        <div>
          ...
          <h1 className="cyber-text font-mono text-3xl font-bold mt-1">CAPTION EXAMPLES</h1>
          <p className="cyber-label mt-1">{examples?.length ?? 0} TOTAL RECORDS</p>
        </div>
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        <Link href={`/caption-examples/${ex.id}/edit`} className="cyber-btn rounded px-3 py-1 text-[0.6rem] inline-block">
                          EDIT
                        </Link>
